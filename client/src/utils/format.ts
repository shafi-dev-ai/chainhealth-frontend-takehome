 ...
 */
export function shortenHash(hash: string | null | undefined, chars = 6): string {
  if (!hash) return '-'
 ...
 */
export function formatUptime(uptime: number | string | null | undefined): string {
...
export function formatGas(
  ...
  const cost = (gasUsed * gasPrice) / 1e9
